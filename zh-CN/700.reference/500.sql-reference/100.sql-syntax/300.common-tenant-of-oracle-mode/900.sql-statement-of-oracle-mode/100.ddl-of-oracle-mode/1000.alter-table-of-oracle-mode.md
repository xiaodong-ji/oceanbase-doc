...
| PARTITION BY RANGE([column_name_list]) [SIZE('size_value')] [range_partition_list] | 用于修改表自动分区的属性。详细介绍可参见 [自动分区](../../../../../300.database-object-management/200.manage-object-of-oracle-mode/200.manage-partitions-of-oracle-mode/250.automatic-partitioning-of-oracle-mode.md) 中的修改表自动分区属性的语法。|
...
更多有关手动分区分裂的信息，参见 [手动分区分裂](../../../../../300.database-object-management/200.manage-object-of-oracle-mode/200.manage-partitions-of-oracle-mode/450.split-partition-of-oracle-mode.md)。
