...
| GV$OB_FLT_TRACE_CONFIG                                                                                                                             | V4.2.1 | 展示全链路诊断的诊断信息。 |
...
| <ul><li>oceanbase.DBA_OB_TABLE_STAT_STALE_INFO </li><li>DBA_OB_TABLE_STAT_STALE_INFO </li></ul>                                                    | V4.2.0 | 展示自上次收集统计信息以来每个表发生的 DDL 操作次数，以及当前统计信息是否已过期。|
