...
该视图展示了所有租户在所有 OBServer 节点上 Function 级别的 IO 统计信息。当 Function 级的后台任务对应的资源组未启用资源管理计划时，展示的 IO 信息仅作为统计参考，对应的资源无法被限制。
...
sys 租户下，查询所有租户在所有 OBServer 节点上 Function 级别的 IO 统计信息。
