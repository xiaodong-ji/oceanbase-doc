...
| enable_auto_split           | V4.3.4  | 控制该表是否需要开启自动分区功能。 |
| auto_split_tablet_size      | V4.3.4  | 控制租户开启自动分区功能之后触发分裂的阈值。 |
| sync_io_thread_count        | V4.3.4  | 配置同步 IO 请求的线程数。 |
...
| 变量名                                                                               | 引入版本    | 描述                             |
|-------------------------------------------------------------------------------------|-------------|---------------------------------|
| [ob_hnsw_ef_search](200.system-variable/400.session-system-variable/550.ob_hnsw_ef_search.md)                                        | V4.3.3 | 于设定 HNSW 向量索引搜索时考虑的邻居节点数。 |
